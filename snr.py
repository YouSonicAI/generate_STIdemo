...
if __name__ == "__main__":
    #filename = '/Users/queenie/Downloads/Ace_test_0401/Dev/Speech/SingleSingle_Office_1_1_M7_s4_Ambient_20dB.wav'
    # filename = '/Users/bajianxiang/Desktop/Elonmusk_01.wav'
    filename = '/Users/bajianxiang/Desktop/Four_Config_3000CStreetGarageStairwell_left_Four_Config_DR8_MKRG0_TIMIT_S_1000dB-37-b056_180_190-0dB-1995.wav'
    ...
    f.close()
    wave_data = np.frombuffer(str_data, dtype=np.int16)  # shape = [323840]

    snr = wada_snr(wave_data)
    print(snr)