...
if __name__ == "__main__":
    ...
    for i in range(len(image_lst)):
        ...
        if sti_value_large_100 < bad_thresh:
            temp = cv2.rectangle(temp, (bar_start_x, bar_start_y),
                                 (bar_start_x + sti_value_large_100 * STRIDE, bar_height + bar_start_y), (128, 0, 128),
                                 thickness=-1)
            ...
            temp = cv2.rectangle(temp, (bar_start_x, bar_start_y), (bar_bad, bar_height + bar_start_y), (128, 0, 128),
                                 thickness=-1)
            temp = cv2.rectangle(temp, (bar_bad, bar_start_y),
                                 (int(bar_bad + (sti_value_large_100 - bad_thresh) * STRIDE), bar_height + bar_start_y),
                                 (0, 0, 255),
                                 thickness=-1)
            ...
            temp = cv2.rectangle(temp, (bar_bad, bar_start_y), (bar_poor, bar_height + bar_start_y), (0, 0, 255),
                                 thickness=-1)
            temp = cv2.rectangle(temp, (bar_poor, bar_start_y), (
            bar_poor + int((sti_value_large_100 - poor_thresh) * STRIDE), bar_height + bar_start_y), (0, 69, 255),
                                 thickness=-1)
            ...
            temp = cv2.rectangle(temp, (bar_poor, bar_start_y), (bar_fair, bar_height + bar_start_y), (0, 69, 255),
                                 thickness=-1)
            temp = cv2.rectangle(temp, (bar_fair, bar_start_y), (
            bar_fair + int((sti_value_large_100 - fair_thresh) * STRIDE), bar_height + bar_start_y), (0, 255, 255),
                                 thickness=-1)
        else:
            temp = cv2.rectangle(temp, (bar_start_x, bar_start_y), (bar_bad, bar_height + bar_start_y), (128, 0, 128),
                                 thickness=-1)
            ...
            temp = cv2.rectangle(temp, (bar_fair, bar_start_y), (bar_good, bar_height + bar_start_y), (0, 255, 255),
                                 thickness=-1)
            temp = cv2.rectangle(temp, (bar_good, bar_start_y), (
            bar_good + int((sti_value_large_100 - good_thresh) * STRIDE), bar_height + bar_start_y), (0, 255, 0),
                                 thickness=-1)
